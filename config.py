...
# NAMA OWNER
OWNER = os.environ.get("OWNER", "J-Hope")
#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "7289855833"))
#Port
PORT = os.environ.get("PORT", "8030")
#Database
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://vascudigama:address64fg@cluster0.hu6a2.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
FORCE_SUB_CHANNEL1 = int(os.environ.get("FORCE_SUB_CHANNEL1", "-1002157930558"))
#put 0 to disable
