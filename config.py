...
"""
#--------------------------------------------
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", "<b>• ʙʏ @KdramaTalkies</b>") #set your Custom Caption here, Keep None for Disable Custom Caption
